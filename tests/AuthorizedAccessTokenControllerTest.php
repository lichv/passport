...
use Lichv\Passport\Client;
use PHPUnit\Framework\TestCase;
use Lichv\Passport\TokenRepository;
use Lichv\Passport\Http\Controllers\AuthorizedAccessTokenController;
...
class AuthorizedAccessTokenControllerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->controller = new Lichv\Passport\Http\Controllers\AuthorizedAccessTokenController(
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $token1 = new Lichv\Passport\Token;
        $token2 = new Lichv\Passport\Token;
    ...
    public function test_tokens_can_be_deleted()
    {
        ...
        $token1 = Mockery::mock(Lichv\Passport\Token::class.'[revoke]');
        $token1->id = 1;
