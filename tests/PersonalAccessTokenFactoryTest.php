...
class PersonalAccessTokenFactoryTest extends TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new Lichv\Passport\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('Lichv\Passport\PersonalAccessTokenResult', $result);
    }
}
...
class PersonalAccessTokenFactoryTestModelStub extends Lichv\Passport\Token
{
    public $id = 1;
    public $secret = 'something';
}
